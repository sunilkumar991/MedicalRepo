...
{
    public partial class PickUpOrderModel : BaseNopEntityModel
    {
        #region Ctor

        public PickUpOrderModel()
        {
        ...
        //Delivery Boy info
        [NopResourceDisplayName("Admin.Orders.Fields.DeliveryBoy")]
        public int? DeliveryBoyId { get; set; }
        //[NopResourceDisplayName("Admin.Orders.Fields.DeliveryBoy")]
        //public string DeliveryBoy { get; set; }
        public CustomerModel DeliveryBoy { get; set; }
        //public List<CustomerModel> DeliveryBoyList { get; set; }
        public IList<Microsoft.AspNetCore.Mvc.Rendering.SelectListItem> DeliveryBoyList { get; set; }

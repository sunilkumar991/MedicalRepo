...
namespace BS.Plugin.NopStation.MobileWebApi.Services
{
    public partial class ContentManagementService : IContentManagementService
    {
        ...
        private readonly IRepository<BS_ContentManagement> _topicRepository;
        ...
        public ContentManagementService(IRepository<BS_ContentManagement> topicRepository,
        ...
        public virtual void DeleteTopic(BS_ContentManagement topic)
        {
            if (topic == null)
        ...
        public virtual BS_ContentManagement GetTopicById(int topicId)
        {
            if (topicId == 0)
                return null;
        ...
        /// <returns>Topic</returns>
        public virtual BS_ContentManagement GetTopicBySystemName(string systemName, int storeId = 0)
        {
        ...
        public virtual IList<BS_ContentManagement> GetAllTopics(int storeId)
        {
        ...
        /// </summary>
        /// <param name="topic">Topic</param>
        public virtual void InsertTopic(BS_ContentManagement topic)
        {
            if (topic == null)
                throw new ArgumentNullException("topic");
        ...
        /// </summary>
        /// <param name="topic">Topic</param>
        public virtual void UpdateTopic(BS_ContentManagement topic)
        {
            if (topic == null)
                throw new ArgumentNullException("topic");

...
{
    public class OKDollarHelper
    {

        public OKDollarHelper()
        {
        ...
        /// </summary>
        public static string OrderTotalSentToOKDollar => "OrderTotalSentToOKDollar";
        ...
        /// </summary>
        /// <param name="paymentStatus">OKDollar payment status</param>
        /// <param name="pendingReason">OKDollar pending reason</param>

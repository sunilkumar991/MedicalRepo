...
namespace Nop.Plugin.Pickup.PickupInStore.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<StorePickupPointCityMappingService>().As<IStorePickupPointCityMappingService>().InstancePerLifetimeScope();
            ...
            //override required repository with our custom context
            builder.RegisterType<EfRepository<StorePickupPointCityMapping>>().As<IRepository<StorePickupPointCityMapping>>()
                .WithParameter(ResolvedParameter.ForNamed<IDbContext>("nop_object_context_pickup_in_store-pickup"))
                .InstancePerLifetimeScope();
        }

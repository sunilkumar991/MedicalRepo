...
namespace Nop.Plugin.Pickup.PickupInStore
{
    public class PickupInStoreProvider : BasePlugin, IPickupPointProvider
    {
            ...
            IStorePickupPointCityMappingService storePickupPointCityMappingService)
        {
            ...
            this._storePickupPointCityMappingService = storePickupPointCityMappingService;
        }
        ...
        //Created By Ankur for getting pickup points from Address
        public GetPickupPointsResponse GetPickupPoints(Address address)
        {
            var result = new GetPickupPointsResponse();
            ...
            if (address != null)
            {
                List<StorePickupPoint> list = _storePickupPointService.GetAllStorePickupPointsByCityId(address.CityId.Value);
                ...
                foreach (var point in list)
                {
                    ...
                    result.PickupPoints.Add(new PickupPoint
                    {
                        //Changed by Ankur on 17 October
                        Id = pointAddress.Id.ToString(),  //Get AddressId as point pointId for binding and selection so address id will get saved 
                        Name = point.Name,
                        Description = point.Description,
                        Address = pointAddress.Address1,
                        City = pointAddress.City,
                        ...
                        Latitude = pointAddress.Latitude,
                        Longitude = pointAddress.Longitude
                    });
                }
        ...
        public override void Install()
        {
            ...
            _storePickupPointService.InsertStorePickupPoint(pickupPoint, 0);

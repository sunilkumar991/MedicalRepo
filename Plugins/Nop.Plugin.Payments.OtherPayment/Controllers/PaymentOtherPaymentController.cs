...
namespace Nop.Plugin.Payments.OtherPayment.Controllers
{
    [AuthorizeAdmin]
    [Area(AreaNames.Admin)]
    public class PaymentOtherPaymentController : BasePaymentController
    {
        #region Fields
        ...
        public PaymentOtherPaymentController(
        ...
        public IActionResult Configure()
        {
            ...
            var cashOnDeliveryPaymentSettings = _settingService.LoadSetting<OtherPaymentPaymentSettings>(storeScope);
            ...
            return View("~/Plugins/Payments.OtherPayment/Views/Configure.cshtml", model);
        }

...
namespace Nop.Data.Mapping.Customers
{
    ...
    public partial class CustomerMap : NopEntityTypeConfiguration<Customer>
    {
        ...
        public override void Configure(EntityTypeBuilder<Customer> builder)
        {
            ...
            builder.Property(customer => customer.OtherEmailAddresses).HasMaxLength(1000); //Added By Ankur On 29/9/2018 As discussion With Mr. Win
            builder.Property(customer => customer.DeviceId).HasMaxLength(1000); //Added By Ankur On 29/9/2018 As discussion With Mr. Win

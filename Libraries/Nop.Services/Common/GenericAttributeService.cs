...
namespace Nop.Services.Common
{
    ...
    public partial class GenericAttributeService : IGenericAttributeService
    {
        ...
        /// <summary>
        /// This is using to get attribtes by customer Id
        /// Created By : Alexandar Rajavel
        /// Created On : 22-Sep-2018
        /// </summary>
        /// <param name="customerId">Attribute identifier</param>
        /// <returns>An attribute</returns>
        public virtual IList<GenericAttribute> GetAttributeByCustomerId(int customerId)
        {
            if (customerId == 0)
                return null;

            var query = from a in _genericAttributeRepository.Table
                        orderby a.Id
                        where a.EntityId == customerId
                        select a;

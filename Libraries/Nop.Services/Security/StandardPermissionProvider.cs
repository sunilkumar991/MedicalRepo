...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord ManageAppAndAddressReviews = new PermissionRecord { Name = "Admin area. Manage App And Address Reviews", SystemName = "ManageAppAndAddressReviews", Category = "Catalog" };
        public static readonly PermissionRecord MedicineRequest = new PermissionRecord { Name = "Admin area. Manage Medicine Request", SystemName = "MedicineRequest", Category = "Medicine" };
        ...
        public static readonly PermissionRecord PaymentTransactionHistory = new PermissionRecord { Name = "Admin area. Payment Transaction History", SystemName = "PaymentTransactionHistory", Category = "Orders" };

...
namespace Nop.Services.ExportImport
{
    ...
    public partial interface IExportManager
    {
        ...
        /// </summary>
        /// <param name="products">Products</param>
        byte[] ExportProductsToXlsxNewBySunilKumar(IEnumerable<Product> products);
        ...
        /// <param name="states">States</param>
        /// <returns>Result in TXT (string) format</returns>
        string ExportBestsellersToTxt(IList<BestsellersReportLine> bestsellers);

        /// <summary>
        /// Export orders to XLSX
        /// </summary>
        /// <param name="orders">Orders</param>
        byte[] ExportBestsellersToXlsx(IList<BestsellersReportLine> bestsellers);
    }
}

...
namespace Nop.Services.Catalog
{
    ...
    public partial class PriceCalculationService : IPriceCalculationService
    {
        ...
        /// <summary>
        /// Modified By Sunil Kumar At 21-02-19
        ...
        protected virtual decimal GetDiscountAmount(Product product,
            Customer customer,
            decimal productPriceWithoutDiscount, decimal additionalCharges,
            out List<DiscountForCaching> appliedDiscounts)
        {
            ...
            //Modified By Sunil Kumar At 21-02-19 for Removing additional Charge Discount for attribute money values
            appliedDiscounts = _discountService.GetPreferredDiscount(allowedDiscounts, productPriceWithoutDiscount - additionalCharges, out appliedDiscountAmount);
            return appliedDiscountAmount;
        }
            ...
            out List<DiscountForCaching> appliedDiscounts)
        {
            ...
            var cachedPrice = _cacheManager.Get(cacheKey, () =>
            {
                ...
                {
                    //discount
                    //Added additionalCharge Param by Sunil Kumar At 21-02-19 for Removing discount for added attributes price also
                    var tmpDiscountAmount = GetDiscountAmount(product, customer, price, additionalCharge, out var tmpAppliedDiscounts);

...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductAttributeService
    {
        ...
        /// <returns>Product attributes</returns>
        IPagedList<ProductAttribute> GetAllProductAttributesByName(int pageIndex = 0, int pageSize = int.MaxValue, string attributeName = "");
        ...
        /// </summary>
        /// <param name="productAttribute">Product attribute</param>
        bool CheckProductAttributeAlreadyExcist(string attribute);

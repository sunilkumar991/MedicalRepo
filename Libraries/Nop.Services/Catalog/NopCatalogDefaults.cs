namespace Nop.Services.Catalog
{
    ...
    public static partial class NopCatalogDefaults
    {
        ...
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string AppAndAddressReviewPatternCacheKey => "Nop.appandaddressreview.";

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string MedicineRequestPatternCacheKey => "Nop.medicinerequest.";

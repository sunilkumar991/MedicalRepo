...
namespace Nop.Services.Catalog
{
    ...
    public partial interface ISpecificationAttributeService
    {
        ...
        IPagedList<SpecificationAttribute> GetSpecificationAttributes(string attributeName = "", int pageIndex = 0, int pageSize = int.MaxValue);
        ...
        bool CheckSpecificationAttributeAlreadyExcist(string attribute);
        ...
        /// <returns>Ids</returns>
        List<int> GetProductSpecificationAttributeOptionIdsByProductIds(int[] productIds);

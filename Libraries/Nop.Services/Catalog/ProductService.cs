    ...
    public partial class ProductService : IProductService
    {
        ...
        public virtual IList<Product> GetAllProduct()
        {
            ...
            query = from p in query
                    from pc in p.ProductCategories.Where(pc =>pc.Category.Name=="Medicine")
                    select p;
        ...
        //added by Sunil Kumar at 01-05-2020
        /// <summary>
        /// Gets all products Count By Vendor ID
        /// </summary>
        /// <returns>Products</returns>
        public virtual int GetAllProductsCountByVendorId(int vendorId = 0)
        {
            var query = (from p in _productRepository.Table
                        orderby p.DisplayOrder, p.Id
        ...
        /// <summary>
        /// Get ProductId by Barcode
        /// <param name="barcode">barcode identifier</param>
        /// <returns>Product</returns>
        public virtual Product GetProductIdbyBarcode(string barcode)
        {
            if (barcode == "" || barcode == null)
                return null;
            var query = from p in _productRepository.Table where p.Barcode == barcode.Trim() select p;
        ...
        /// </param>
        /// <returns>Products</returns>
        public virtual IPagedList<Product> SearchProductsNewBuidID(
            int pageIndex = 0,
        ...
        {
            return SearchProductsNewBuidID(out var _, out var _, false,
        ...
        public virtual IPagedList<Product> SearchProducts(
            ...
            bool? overridePublished = null)
        {
            return SearchProducts(out var _, out var _, false,
                pageIndex, pageSize, categoryIds, manufacturerId,
                storeId, vendorId, warehouseId,
                productType, visibleIndividuallyOnly, markedAsNewOnly, featuredProducts,
                priceMin, priceMax, productTagId, keywords, searchDescriptions, searchManufacturerPartNumber, searchSku,
        ...
        public virtual IPagedList<Product> SearchProductsNewBuidID(
            ...
            out IList<int> filterableProductIds,
            ...
            bool? overridePublished = null)
        {
            ...
            filterableProductIds = new List<int>();
            ...
            var pFilterableProductIds = _dataProvider.GetOutputStringParameter("FilterableProductIds");
            pFilterableProductIds.Size = int.MaxValue - 1;

            //invoke stored procedure
            var products = _dbContext.EntityFromSql<Product>("ProductLoadAllPagedNewBuid",
                pCategoryIds,
                pManufacturerId,
                pStoreId,
                pVendorId,
            ...
            var filterableProductIdsStr =
                pFilterableProductIds.Value != DBNull.Value
                    ? (string)pFilterableProductIds.Value
                    : string.Empty;
            ...
            if (loadFilterableSpecificationAttributeOptionIds &&
                !string.IsNullOrWhiteSpace(filterableProductIdsStr))
            {
                filterableProductIds = filterableProductIdsStr
                    .Split(new[] { ',' }, StringSplitOptions.RemoveEmptyEntries)
                    .Select(x => Convert.ToInt32(x.Trim()))
                    .ToList();
            }

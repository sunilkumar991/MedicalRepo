...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductAttributeService : IProductAttributeService
    {
        ...
        /// <summary>
        /// Gets all product attributes by Name
        /// </summary>
        /// <param name="pageIndex">Page index</param>
        /// <param name="pageSize">Page size</param>
        /// <param name="attributeName">Attribute Name</param>
        /// <returns>Product attributes</returns>
        public virtual IPagedList<ProductAttribute> GetAllProductAttributesByName(int pageIndex = 0, int pageSize = int.MaxValue, string attributeName = "")
        {
            var key = string.Format(NopCatalogDefaults.ProductAttributesAllCacheKey, pageIndex, pageSize);
            return _cacheManager.Get(key, () =>
            {
        ...
        /// <summary>
        /// Check product attribute already excist
        /// </summary>
        /// <param name="productAttribute">Product attribute</param>
        public virtual bool CheckProductAttributeAlreadyExcist(string attribute)
        {
            if (attribute == null)

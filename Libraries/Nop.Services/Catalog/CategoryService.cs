...
namespace Nop.Services.Catalog
{
    ...
    public partial class CategoryService : ICategoryService
    {
        ...
        /// <param name="loadCacheableCopy">A value indicating whether to load a copy that could be cached (workaround until Entity Framework supports 2-level caching)</param>
        /// <returns>Categories</returns>
        public virtual IList<Category> GetAllCategoriesNew(int storeId = 0, bool showHidden = false, bool loadCacheableCopy = true)
        {
            IList<Category> LoadCategoriesFunc1() => GetAllCategoriesnewBuid(string.Empty, storeId, showHidden: showHidden);
            ...
            if (loadCacheableCopy)
            {
                ...
                {
                    var result = new List<Category>();
                    foreach (var category in LoadCategoriesFunc1())
                        result.Add(new CategoryForCaching(category));
                    return result;
                });
            }
            ...
            {
                categories = LoadCategoriesFunc1();
            }
        ...
        /// <summary>
        /// Gets all categories for new buid
        /// </summary>
        ...
        /// <param name="showHidden">A value indicating whether to show hidden records</param>
        /// <returns>Categories</returns>
        public virtual IPagedList<Category> GetAllCategoriesnewBuid(string categoryName, int storeId = 0,
            int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false)
        {
            if (_commonSettings.UseStoredProcedureForLoadingCategories)
            {
                ...
                var categories = _dbContext.EntityFromSql<Category>("CategoryLoadAllPagedNewBUID",
            ...
            query = query.Where(c => !c.Deleted && c.Id == 5233 && c.Id == 5234 && c.Id == 5235 && c.Id == 5236);
        ...
        /// <param name="showHidden">A value indicating whether to show hidden records</param>
        /// <returns>Categories</returns>
        public virtual IList<Category> GetAllCategoriesDisplayedOnHomePageNewBuid(bool showHidden = false)
        {

            //List<int> integerList = new List<int>()
            //{
            //    5130, 5153, 5178, 5180,5191,5208,5209,5210,5211, 5212,5213, 5214, 5215, 5216, 5217, 5218, 5341, 5342, 5349, 5350, 5399, 5400, 5456
            //};
            List<int> integerList = new List<int>()
            {
                5213, 5214, 5350
            ...
            var query = from c in _categoryRepository.Table
                        ...
                        where QuerySyntax.Contains(c.Id) && c.Published &&
                        !c.Deleted &&
                        c.ShowOnHomePage
                        select c;
        ...
        public virtual string GetCategoryNameById(int categoryId)
        {

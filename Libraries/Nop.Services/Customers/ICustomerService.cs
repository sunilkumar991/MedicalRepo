...
namespace Nop.Services.Customers
{
    ...
    public partial interface ICustomerService
    {
        ...
        /// Get all customer by GUID
        /// </summary>
        /// <param name="customerGuid">Customer GUID</param>
        /// <returns>All customers</returns>
        IList<Customer> GetAllCustomerByGuid(Guid customerGuid);
        ...
        /// Gets a customer
        /// </summary>
        /// <param name="addressId">Customer identifier</param>
        /// <returns>A customer</returns>
        Customer GetCustomerByAddressId(int addressId);
        ...
        void DeleteCustomerByUserName(Customer customer);
        ...
        IList<Customer> GetDeliveryBoyList(string orderStatus);
    }
}
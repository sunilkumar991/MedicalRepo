...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        private readonly IRepository<CustomerRemark> _customerRemarkRepository; //Added by Ankur to add remark
        ...
        public CustomerService(CustomerSettings customerSettings,
            ...
            IRepository<CustomerRemark> customerRemarkRepository,
            IStaticCacheManager staticCacheManager)
        {
            ...
            this._customerRemarkRepository = customerRemarkRepository;
        ...
        /// Created By: Alexandar Rajvel
        /// Created On: 29-Sep-2018
        /// </summary>
        /// <param name="customer">Customer identifier</param>
        /// <returns>Deleted</returns>
        public virtual void DeleteCustomerByUserName(Customer customer)
        {
        ...
        public virtual Customer GetCustomerById(int customerId)
        {
            ...
            var query = (from c in _customerRepository.Table
                        where c.Id == customerId && c.Deleted == false
                        orderby c.Id
        ...
        public virtual Customer GetCustomerByGuid(Guid customerGuid)
        {
            ...
            var query = from c in _customerRepository.Table
                        where c.CustomerGuid == customerGuid && c.Deleted == false
                        orderby c.Id
                        select c;
        ...
        /// <param name="customerGuid">Customer GUID</param>
        /// <returns>A customer</returns>
        public virtual IList<Customer> GetAllCustomerByGuid(Guid customerGuid)
        {
            if (customerGuid == Guid.Empty)
                return null;
        ...
        public virtual Customer GetCustomerByUsername(string username)
        {
            ...
            var query = from c in _customerRepository.Table
                        orderby c.Id
                        where c.Username == username && c.Active == true && c.Deleted == false //Added check for Active & Delete
                        select c;
            var customer = query.FirstOrDefault();
            return customer;
        }
        ...
        /// <summary>
        /// Get customer by address id
        /// Created By : Alexandar Rajavel
        /// Created On : 21-Sep-2018
        /// </summary>
        /// <param name="addressId">Addres id</param>
        /// <returns>Customer</returns>
        public virtual Customer GetCustomerByAddressId(int addressId)
        {
            if (addressId == 0)
                return null;
            ...
            var query = from c in _customerRepository.Table
                        orderby c.Id
                        where c.BillingAddressId == addressId
                        select c;
            var customer = query.FirstOrDefault();
            return customer;
        }
        ...
        {
            //Sunil Kumar - get current IP address
            ...
            //customer.CustomerCustomerRoleMappings.Add(new CustomerCustomerRoleMapping { CustomerId = customer.Id, CustomerRoleId = guestRole.Id });
            ...
            bool clearPaymentMethod = true)
        {
            ...
            if (clearPaymentMethod)
            {
                ...
                _genericAttributeService.SaveAttribute<string>(customer, "SubPaymetnType", null, storeId);
            }
        ...
        #region Customer Remark
        /// <summary>
        /// Inserts a customer role
        /// </summary>
        /// <param name="customerRole">Customer role</param>
        public virtual void InsertCustomerRemark(CustomerRemark customerRemark)
        {
            if (customerRemark == null)
                throw new ArgumentNullException(nameof(customerRemark));

            _customerRemarkRepository.Insert(customerRemark);

            //_cacheManager.RemoveByPattern(NopCustomerServiceDefaults.CustomerRolesPatternCacheKey);

            //event notification
            _eventPublisher.EntityInserted(customerRemark);
        }
        #endregion
        ...
        /// Creaded On : 3-SEP-2018
        /// </summary>
        /// <param name="searchModel"></param>
        /// <returns></returns>
        public virtual IList<Customer> GetDeliveryBoyList(string orderStatus)
        {
            int? DeliveryBoyRoleId = _customerRoleRepository.Table.Where(r => r.Name == "Delivery Boy").FirstOrDefault().Id;
            var query = from c in _customerRepository.Table
                        ...
                        where cr.Id == DeliveryBoyRoleId
                        select c;

            if (orderStatus.ToLower() == "processing" || orderStatus.ToLower() == "pending")
            {

...
namespace Nop.Services.Messages
{
    ...
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        public virtual void AddOrderTokens(IList<Token> tokens, Order order, int languageId, int vendorId = 0)
        {
            ...
            //Added Code By Sunil Kumar At 15-04-2020
            //tokens.Add(new Token("Order.BillingCity", order.BillingAddress.City));
            tokens.Add(new Token("Order.BillingCity", order.BillingAddress.City != null ? _localizationService.GetLocalized(order.BillingAddress.City, x => x.Name) : string.Empty));
            ...
            tokens.Add(new Token("Order.ShippingCity", order.ShippingAddress != null ? order.ShippingAddress.City?.Name : string.Empty));

...
namespace Nop.Services.Helpers
{
    ...
    public partial class DateTimeHelper : IDateTimeHelper
    {
        ...
        /// <summary>
        /// Added By Ankur for returning date as string..
        /// </summary>
        /// <param name="dt"></param>
        /// <returns></returns>
        public virtual string ConvertDateAsText(DateTime dt)
        {
            return dt!= null ? dt.ToString("dddd, dd MMMM yyyy") : string.Empty;
        }

...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderReportService : IOrderReportService
    {
            ...
            PaymentStatus? ps, ShippingStatus? ss, DateTime? startTimeUtc, DateTime? endTimeUtc)
        {
            ...
            query = query.Where(o => o.PaymentStatusId != (int)PaymentStatus.Pending); // Remove Payment pending status for admin by ankur on 28 Sep. 2019
            ...
            bool showHidden = false)
        {
            ...
            var query1 = from orderItem in _orderItemRepository.Table
                         ...
                         where (storeId == 0 || storeId == o.StoreId) &&
                                o.PaymentStatusId != (int)PaymentStatus.Pending && //Remove Payment pending status order for admin by ankur on 28 Sep. 2019
            ...
            string billingPhone = null, string billingEmail = null, string billingLastName = "", string orderNotes = null)
        {
            ...
            orders = orders.Where(o => o.PaymentStatusId != (int)PaymentStatus.Pending); // Remove Payment pending status for admin by ankur on 28 Sep. 2019
            if (osIds != null && osIds.Any())

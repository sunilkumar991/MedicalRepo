...
namespace Nop.Services.Orders
{
    ...
    public partial interface IShoppingCartService
    {
        ...
        /// <returns>Number of deleted items</returns>
        int DeleteShoppingCartItems(int ProductID, int CustomerID, int shoppingCartTypeId);
        ...
        IList<string> GetStandardWarnings(Customer customer, ShoppingCartType shoppingCartType,
            ...
            decimal customerEnteredPrice, int quantity, int count);
        ...
        /// <returns>Warnings</returns>
        ErrorListModel GetShoppingCartItemWarnings(Customer customer, ShoppingCartType shoppingCartType,
        ...
        /// <param name="addRequiredProducts">Whether to add required products</param>
        /// <returns>Warnings</returns>
        ErrorListModel AddToCart(Customer customer, Product product,
        ...
        /// <param name="fromCustomer">From customer</param>
        /// <param name="toCustomer">To customer</param>
        void MigrateShoppingCartNew(Customer fromCustomer, Customer toCustomer);

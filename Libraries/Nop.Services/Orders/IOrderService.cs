...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderService
    {
        ...
        /// <param name="customOrderNumber">The custom order number</param>
        /// <returns>Order</returns>
        Order GetOrderByCustomOrderNumberForDelivery(string customOrderNumber);
        ...
        /// <returns>Order</returns>
        IList<Order> GetMyDeliveredList(int deliveryBoyId);

        /// <summary>
        /// Get Order List By Delivery Boy Id
        /// </summary>
        /// <param name="deliveryBoyId">delivery Boy Id</param>
        /// <returns>Order</returns>
        IList<Order> GetOrderListByDeliveryBoyId(int deliveryBoyId);
        ...
        /// <returns>Order</returns>
        List<Order> GetOrdersByTransactionId(string trasactionId);
        ...
        IPagedList<Order> SearchOrdersForAdmin(int storeId = 0,
        ...
        /// <summary>
        /// Search orders by date acending
        /// </summary>
        ...
        /// <param name="editDateTime"></param>
        /// <returns></returns>
        IPagedList<Order> SearchOrdersForPickUp1(int storeId = 0,
            int vendorId = 0, int customerId = 0,
            int productId = 0, int affiliateId = 0, int warehouseId = 0,
            int billingCountryId = 0, string paymentMethodSystemName = null,
            DateTime? createdFromUtc = null, DateTime? createdToUtc = null,
            List<int> osIds = null, List<int> psIds = null, List<int> ssIds = null,
            string billingPhone = null, string billingEmail = null, string billingLastName = "",
            string orderNotes = null, string customOrderNumber = null, int pageIndex = 0, 
            int pageSize = int.MaxValue, bool getOnlyTotalCount = false, string deviceId = null, 
            DateTime? editDateTime = null, DateTime? editEndDate = null);
        ...
        /// <param name="CustomerId"></param>
        /// <returns></returns>
        int GetMaxOrderGroupNumber(int CustomerId);
        ...
        /// <returns></returns>
        List<Order> GetOrdersByOrderGroupNumber(int CustomerId, int OrderGroupNumber);

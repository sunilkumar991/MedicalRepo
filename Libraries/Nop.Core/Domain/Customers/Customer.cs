...
namespace Nop.Core.Domain.Customers
{
    ...
    public partial class Customer : BaseEntity
    {
        ...
        /// <summary>
        /// store all other email address of customer
        /// </summary>
        public string OtherEmailAddresses { get; set; }  //Added By Ankur On 29/9/2018 As discussion With Mr. Win

        /// <summary>
        /// Gets or sets the email that should be re-validated. Used in scenarios when a customer is already registered and wants to change an email address.
        /// </summary>
        public string DeviceId { get; set; } //Added By Ankur On 29/9/2018 As discussion With Mr. Win

        /// <summary>
        /// Gets or sets the sim identifier
        /// </summary>
        public string SimId { get; set; }

        /// <summary>
        /// Gets or sets the ProfilePictureUrl
        /// </summary>
        public string ProfilePictureUrl { get; set; }

        /// <summary>
        /// Gets or sets the ViberNumber
        /// </summary>
        public string ViberNumber { get; set; }

        /// <summary>
        /// Gets or sets the DisplayAvatar
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the Other mobile number
        /// </summary>
        public string OtherMobileNumber { get; set; }

        //added by Sunil at 29-04-19
        /// <summary>
        /// Gets or sets the VersionCode of the customer 
        /// </summary>
        public int VersionCode { get; set; }

        /// <summary>
        /// Gets or sets the RecentlyViewedProductsIds
        /// </summary>
        public string RecentlyViewedProductsIds { get; set; }

        /// <summary>
        /// Gets or sets the RecentlySearchedKeyWords
        /// </summary>
        public string RecentlySearchedKeyWords { get; set; }
        ...
        //added by Sunil at 14-05-2020
        /// <summary>
        /// Gets or sets the ShopName of the customer 
        /// </summary>

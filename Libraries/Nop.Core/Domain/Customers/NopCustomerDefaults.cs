...
namespace Nop.Core.Domain.Customers
{
    ...
    public static partial class NopCustomerDefaults
    {
        ...
        /// Gets a name of generic attribute to store the value of 'LastName'
        /// </summary>
        public static string IsDisplayEmail => "IsDisplayEmail";
        ...
        /// Gets a name of generic attribute to store the value of 'City'
        /// </summary>
        public static string CityIdAttribute => "City";
        ...
        /// <summary>
        /// EC-181 - Added this attribute for pickup point by Ankur on 26/10/2018
        /// </summary>
        public static string PickupPointAddressId => "PickupPointAddressId";

        /// <summary>
        /// Added this attribute for Address by Sunil Kumar on 07/12/2018
        /// Gets a name of generic attribute to store the value of 'HouseNo'
        /// </summary>
        public static string HouseNoAttribute => "HouseNo";

        /// <summary>
        /// Gets a name of generic attribute to store the value of 'FloorNo'
        /// </summary>
        public static string FloorNoAttribute => "FloorNo";

        /// <summary>
        /// Gets a name of generic attribute to store the value of 'RoomNo'
        /// </summary>
        public static string RoomNoAttribute => "RoomNo";

        /// <summary>
        /// Gets a name of generic attribute to store the value of 'IsLiftOption'
        /// </summary>
        public static string IsLiftOptionAttribute => "IsLiftOption";

        /// <summary>
        /// Gets a name of generic attribute to store the value of 'RopeColor'
        /// </summary>
        public static string RopeColorAttribute => "RopeColor";

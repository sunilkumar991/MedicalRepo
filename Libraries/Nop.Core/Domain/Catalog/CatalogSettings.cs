...
namespace Nop.Core.Domain.Catalog
{
    ...
    public class CatalogSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the App and Address reviews should be sorted by creation date as ascending
        /// </summary>
        public bool AppAndAddressReviewsSortByCreatedDateAscending { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether the PaymentTransactionHistory should be sorted by creation date as ascending
        /// </summary>
        public bool PaymentTransactionHistorySortByCreatedDateAscending { get; set; }
        ...
        /// <summary>
        /// Gets or sets a number of "Recently Searched Key Words Number"
        /// </summary>
        public int RecentlySearchedKeyWordsNumber { get; set; }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether "Recently Searched Key Words Enabled" feature is enabled
        /// </summary>
        public bool RecentlySearchedKeyWordsEnabled { get; set; }

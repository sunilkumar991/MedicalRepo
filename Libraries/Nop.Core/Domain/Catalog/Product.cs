...
namespace Nop.Core.Domain.Catalog
{
    ...
    public partial class Product : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported, IDiscountSupported
    {
        ...
        /// <summary>
        /// Added By Sunil Kumar On 17/August/2021
        /// Gets or sets the ERPItemCode of product
        /// </summary>
        public string ERPItemCode { get; set; }

        /// <summary>
        /// Added By Sunil Kumar On 17/August/2021
        /// Gets or sets the skucodeerp of product
        /// </summary>
        public string skucodeerp { get; set; }

        /// <summary>
        /// Added By Sunil Kumar On 15/02/2019
        /// Gets or sets the Rating Url From GSMArena of product
        /// </summary>
        public string RatingUrlFromGSMArena { get; set; }

        /// <summary>
        /// Added By Alexandar Rajavel On 15/02/2019
        /// Gets or sets the value whether the product is reserved
        /// </summary>
        public bool IsReserved { get; set; }

        /// <summary>
        /// Added By Alexandar Rajavel On 05-Mar-2019
        /// Gets or sets the reserved customer Ids
        /// </summary>
        public string ReservedCustomerIds { get; set; }

        /// <summary>
        /// Item id from ERP to map with 1 Stop Mart.
        /// </summary>
        public string CGMItemID { get; set; }

        /// <summary>
        /// Added By Alexandar Rajavel On 05-Mar-2019
        /// Gets or sets the ReservedQty
        /// </summary>
        public int ReservedQty { get; set; }

        /// <summary>
        /// Added By Alexandar Rajavel On 29-Mar-2019
        /// Gets or sets the customer Ids to send the notification 
        /// ManageInventoryMethod by ManageStock
        /// </summary>
        public string NotificationToCustomers { get; set; }

        /// <summary>
        /// Added By Alexandar Rajavel On 29-Mar-2019
        /// Gets or sets the customer Ids to send the notification
        /// ManageInventoryMethod by ManageStockByAttributes
        /// </summary>
        public string NotificationToCustomers_1 { get; set; }

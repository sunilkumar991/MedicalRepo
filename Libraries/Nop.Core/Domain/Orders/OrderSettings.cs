...
namespace Nop.Core.Domain.Orders
{
    ...
    public class OrderSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets an AdminToken for sending notification to ware house management
        /// </summary>
        public string AdminTokenforWHM { get; set; }

        /// <summary>
        /// Gets or sets an Api url for sending notification to ware house management
        /// </summary>
        public string ApiUrlforWHM { get; set; }
    }
}
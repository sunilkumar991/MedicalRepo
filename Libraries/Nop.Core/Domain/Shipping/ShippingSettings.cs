...
namespace Nop.Core.Domain.Shipping
{
    ...
    public class ShippingSettings : ISettings
    {
        ...
        // Added by Alexandar Rajavel on 10-June-2019
        /// <summary>
        /// Gets or sets a value of AdditionalShippingCharge_1_to_5Kg
        /// </summary>
        public decimal AdditionalShippingChargeFor_1_to_5Kg { get; set; }

        /// <summary>
        /// Gets or sets a value of AdditionalShippingCharge_5_to_10Kg
        /// </summary>
        public decimal AdditionalShippingChargeFor_5_to_10Kg { get; set; }

        /// <summary>
        /// Gets or sets a value of AdditionalShippingCharge_10_to_20Kg
        /// </summary>
        public decimal AdditionalShippingChargeFor_10_to_20Kg { get; set; }

        /// <summary>
        /// Gets or sets a value of AdditionalShippingChargeAbove_20Kg
        /// </summary>
        public decimal AdditionalShippingChargeForAbove_20Kg { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether calculating shipping charge qty wise or order wise
        /// </summary>
        public bool IsShippingChargeQtyWise { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether calculating shipping charge qty wise or order wise
        /// </summary>
        public int ShowDeliveredListCount { get; set; }
    }
}
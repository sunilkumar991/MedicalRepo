...
namespace Nop.Web.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<AppAndAddressReviewModelFactory>().As<IAppAndAddressReviewModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<MedicineRequestModelFactory>().As<IMedicineRequestModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<PaymentTransactionHistoryModelFactory>().As<IPaymentTransactionHistoryModelFactory>().InstancePerLifetimeScope();
            ...
            //builder.RegisterType<AdminPanelNotificationService>().As<IAdminPanelNotificationService>().InstancePerLifetimeScope();

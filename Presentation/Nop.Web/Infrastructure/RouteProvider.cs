...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IRouteBuilder routeBuilder)
        {
            ...
            //get City list by State ID For Order Booking (AJAX link)  -- Cretaed by Ankur on 27/8/2018
            routeBuilder.MapRoute("GetCitiesByStateIdForShipping", "country/GetCitiesByStateIdForShipping/",
                new { controller = "Country", action = "GetCitiesByStateIdForShipping" });

            //get City list by State ID  (AJAX link)  -- Cretaed by Ankur on 27/8/2018
            routeBuilder.MapRoute("GetCitiesByStateId", "country/GetCitiesByStateId/",
                new { controller = "Country", action = "GetCitiesByStateId" });

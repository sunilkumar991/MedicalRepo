...
namespace Nop.Web.Validators.Common
{
    public partial class AddressValidator : BaseNopValidator<AddressModel>
    {
            ...
            AddressSettings addressSettings)
        {
            ...
            if (addressSettings.CityEnabled && addressSettings.CityRequired)
            {
                RuleFor(x => x.CityId)
                    .NotNull()
            ...
            {
                RuleFor(x => x.CityId).NotEmpty().WithMessage(localizationService.GetResource("Account.Fields.City.Required"));
            }

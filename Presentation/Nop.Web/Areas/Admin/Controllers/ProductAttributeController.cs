...
namespace Nop.Web.Areas.Admin.Controllers
{
    public partial class ProductAttributeController : BaseAdminController
    {
        ...
        [HttpGet]
        public JsonResult CheckAttributeNameIsAlreadyExist(string productAttribute)
        {
            var updateFlag = _productAttributeService.CheckProductAttributeAlreadyExcist(productAttribute);

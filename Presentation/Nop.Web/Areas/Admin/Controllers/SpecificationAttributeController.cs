...
namespace Nop.Web.Areas.Admin.Controllers
{
    public partial class SpecificationAttributeController : BaseAdminController
    {
        ...
        [HttpGet]
        public JsonResult CheckAttributeNameIsAlreadyExist(string specificationAttribute)
        {
            var updateFlag = _specificationAttributeService.CheckSpecificationAttributeAlreadyExcist(specificationAttribute);

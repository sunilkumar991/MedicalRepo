...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface IBaseAdminModelFactory
    {
        ...
        /// <summary>
        /// Prepare City List based on State ID
        /// </summary>
        /// <param name="items"></param>
        /// <param name="stateId"></param>
        /// <param name="withSpecialDefaultItem"></param>
        /// <param name="defaultItemText"></param>
        void PrepareCities(IList<SelectListItem> items, int? stateId, bool withSpecialDefaultItem = true, string defaultItemText = null);
    }
}
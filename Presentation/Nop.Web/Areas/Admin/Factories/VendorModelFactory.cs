...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class VendorModelFactory : IVendorModelFactory
    {
        ...
        protected virtual void PrepareAddressModel(AddressModel model, Address address)
        {
            ...
            //Added code by Sunil Kumar at 01-11-19
            model.CountryRequired = true;
            model.StateProvinceRequired = true;
            ...
            //Added code by Sunil Kumar At 02-11-19
            //prepare available cities
            _baseAdminModelFactory.PrepareCities(model.AvailableCities, model.StateProvinceId);
        ...
        public virtual VendorModel PrepareVendorModel(VendorModel model, Vendor vendor, bool excludeProperties = false)
        {
            ...
            //Modified code by Sunil Kumar at 01-11-19
            model.Latitude = address != null ? (address.Latitude == null ? 0 : (decimal)address.Latitude) : 0;
            model.Longitude = address != null ? (address.Longitude == null ? 0 : (decimal)address.Longitude) : 0;

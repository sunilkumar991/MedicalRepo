...
namespace Nop.Web.Areas.Admin.Models.Settings
{
    ...
    public partial class ProductEditorSettingsModel : BaseNopModel, ISettingsModel
    {
        ...
        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.Barcode")]
        public bool Barcode { get; set; }


        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.ERPItemCode")]
        public bool ERPItemCode { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.skucodeerp")]
        public bool skucodeerp { get; set; }



        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.RatingUrlFromGSMArena")]
        public bool RatingUrlFromGSMArena { get; set; }

...
namespace Nop.Web.Areas.Admin.Models.Catalog
{
        ...
        IAclSupportedModel, IDiscountSupportedModel, ILocalizedModel<ProductLocalizedModel>, IStoreMappingSupportedModel
    {
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ERPItemCode")]
        public string ERPItemCode { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.skucodeerp")]
        public string skucodeerp { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.RatingUrlFromGSMArena")]

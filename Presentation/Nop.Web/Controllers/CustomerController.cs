    ...
    public partial class CustomerController : BasePublicController
    {
                ...
                if (registrationResult.Success)
                {
                    ...
                    var defaultAddress = new Address
                    {
                        ...
                        StateProvinceId = _genericAttributeService.GetAttribute<int>(customer, NopCustomerDefaults.StateProvinceIdAttribute) > 0
                            ...
                            : null,
                        CityId = _genericAttributeService.GetAttribute<int>(customer, NopCustomerDefaults.CityIdAttribute) > 0
                            ? (int?)_genericAttributeService.GetAttribute<int>(customer, NopCustomerDefaults.CityIdAttribute)
                            : null,
        ...
        public virtual IActionResult AddressAdd(CustomerAddressEditModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //Added by ankur on 3rd Nov. 2018
                if (string.IsNullOrEmpty(address.Email))
                    address.Email = "orders@zayok.com";

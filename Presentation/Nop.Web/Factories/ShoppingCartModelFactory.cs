    ...
    public partial class ShoppingCartModelFactory : IShoppingCartModelFactory
    {
            ...
            bool prepareAndDisplayOrderReviewData = false)
        {
            ...
            if (!minOrderSubtotalAmountOk)
            {
                ...
                var minOrderValue = cityValue != null ? cityValue.MinOrderValue : _orderSettings.MinOrderSubtotalAmount;

                //Commented on 04-05-2020 By Sunil Kumar S
                ...
                var minOrderSubtotalAmount = _currencyService.ConvertFromPrimaryStoreCurrency((decimal)minOrderValue, _workContext.WorkingCurrency);
            ...
            foreach (var sci in cart)
            {
                ...
                {
                    cartItemModel.DeliveryDate = _localizationService.GetLocalized(deliveryDate, dd => dd.Name);
                }

...
namespace Nop.Web.Factories
{
    ...
    public partial class ProductModelFactory : IProductModelFactory
    {
                ...
                if (attribute.ShouldHaveValues())
                {
                    ...
                    foreach (var attributeValue in attributeValues)
                    {
                        var valueModel = new ProductDetailsModel.ProductAttributeValueModel
                        {
                            ...
                            MeasurementData = System.Web.HttpUtility.HtmlEncode(attributeValue.MeasurementData)
                        };
                        ...
                        if (_permissionService.Authorize(StandardPermissionProvider.DisplayPrices))
                        {
                            ...
                            if (attributeValue.PriceAdjustmentUsePercentage)
                            {
                                ...
                                if (attributeValue.PriceAdjustment > decimal.Zero)
                                    //Commented on 12-03-2020 By Sunil Kumar for Removing + Symbol in Price Adjustment
                                    //valueModel.PriceAdjustment = "+";
                                    //Commented on 28-03-2020 By Sunil Kumar for Removing % Symbol in Price Adjustment
                                    //valueModel.PriceAdjustment += priceAdjustmentStr + "%";
                                    valueModel.PriceAdjustment += priceAdjustmentStr+" MMK";
                            }
                            else
                            {
        ...
        public virtual ProductReviewsModel PrepareProductReviewsModel(ProductReviewsModel model, Product product)
        {
            ...
            //Commented by Sunil Kumar at 24/10/18
            ...
            model.AddProductReview.CanCurrentCustomerLeaveReview = hasCompletedOrders;

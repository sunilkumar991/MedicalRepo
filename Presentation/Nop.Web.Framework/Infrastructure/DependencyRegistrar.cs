...
using Nop.Services.AppUpgradeDetails;
...
namespace Nop.Web.Framework.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<CityService>().As<ICityService>().InstancePerLifetimeScope(); // Added by ankur on 27-AUG-2018
            // Added by Alexandar Rajavel on 05-Nov-2018
            builder.RegisterType<PaymentTransactionHistoryService>().As<IPaymentTransactionHistoryService>().InstancePerLifetimeScope();
            // Added by Alexandar Rajavel on 17-Nov-2018
            builder.RegisterType<ProductReviewService>().As<IProductReviewService>().InstancePerLifetimeScope();
            // Added by Sunil Kumar S on 24-Jan-2019
            builder.RegisterType<AppAndAddressReviewService>().As<IAppAndAddressReviewService>().InstancePerLifetimeScope();
            // Added by Alexandar Rajavel on 08-Feb-2019
            builder.RegisterType<HelpandSupportService>().As<IHelpandSupportService>().InstancePerLifetimeScope();
            // Added by Alexandar Rajavel on 30-Mar-2019
            ...
            builder.RegisterType<MedicineRequestService>().As<IMedicineRequestService>().InstancePerLifetimeScope();

            builder.RegisterType<ActionContextAccessor>().As<IActionContextAccessor>().InstancePerLifetimeScope();
            // Added by Alexandar Rajavel on 03-Jan-2020
            builder.RegisterType<AppUpgradeService>().As<IAppUpgradeService>().InstancePerLifetimeScope();
